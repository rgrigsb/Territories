...
public class CardBakeScript : MonoBehaviour {
	...
	public Material Bake() {
		...
		var flavor_text = transform.FindChild("Flavor").GetComponent<TextMesh>();
		flavor_text.text = card_data_.flavor;
		...
		transform.FindChild("Flavor").gameObject.layer = active_card_layer;
		...
		transform.FindChild("Flavor").gameObject.layer = card_layer;
